...
public class DataProvider {
	...
	public static Object[][] getData(String DataFileName, String SheetName, String TestName) {

		ReadExcelFile readdata = new ReadExcelFile(System.getProperty("user.dir") + "\\TestData\\" + DataFileName);
